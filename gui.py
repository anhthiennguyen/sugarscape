...
class GUI:
    ...
    def configureAgentColorNames(self):
        return ["Branches", "Decision Models", "Depression", "Disease", "Government", "Metabolism", "Movement", "Races", "Sex", "Tribes", "Vision"]
    ...
    def lookupFillColor(self, cell):
        ...
        if agent == None:
        ...
        elif self.activeColorOptions["agent"] == "Branches":
            ...
            if agent in (agentLocke.get("governmentLegislature") or frozenset()):
                return self.colors["legislature"]
